...
const DATA = {
  ...
  costumbres: [
    ...
    { icono: "✊", titulo: "Sobre las protestas (leed esto)", texto: "Contexto: el movimiento nació con la tragedia de Novi Sad (nov. 2024, 16 muertos) y tras 18 meses de pulso ha llegado a su momento decisivo JUSTO ahora: el 27 de junio Vučić anunció que dimitirá «en cuestión de semanas» y que habrá elecciones anticipadas. Desde entonces la tensión ha subido, no bajado: gran protesta el 28-jun en Slavija con choques y decenas de detenidos, y una oleada de 400+ detenciones a principios de julio criticada por la ONU y el Consejo de Europa. Vais a estar en Belgrado en semanas potencialmente históricas — habrá concentraciones (de protesta y de celebración), y OJO: Slavija, epicentro habitual, está a 10 minutos de vuestro apartamento. Qué significa para vosotros: presencia policial visible, cortes de tráfico, y quizá alguna noche de ruido de cacerolas o bocinas. Nada dirigido a turistas. Regla triple: (1) ante concentración o antidisturbios, cambiad de calle y seguid con vuestro plan; (2) cero fotos de cerca a cordones policiales; (3) mirad N1info.rs (en inglés) por la mañana — las convocatorias grandes se anuncian con días. Verificado el 17-jul-2026; esto evoluciona rápido." },
  ],
  idioma: {
