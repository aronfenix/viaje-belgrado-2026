...
const DATA = {
  ...
  dias: [
    { fecha: "2026-07-22", nota: "¡Hoy! Vuelo desde Madrid ~16:00 → Belgrado. Chequead el estado del vuelo en la app de Air Serbia antes de salir de casa (hoy hay chubascos, ≈60%, puede haber algún retraso menor). Al aterrizar: SIM en el aeropuerto si el kiosco sigue abierto (~20:00) y taxi-voucher o bus a Risanska. Primera noche con lluvia probable = plan bajo techo sin agobios: una kafana cercana y la primera rakija. Bienvenidos.", tipo: "llegada" },
  ...
  mapaZonas: {
    ...
    zonas: [
      ...
      { id: "novi-beograd", nombre: "Novi Beograd · Ušće", corto: "NOVI BEOGRAD", sub: "Yugoslavia moderna", barrios: ["novi-beograd"], centro: [44.8130, 20.4250], radio: 2.5, path: "M55 155 Q175 120 310 165 L345 235 Q255 300 95 285 Z", label: [195, 210], visual: "mocab" },
      { id: "ada", nombre: "Ada Ciganlija", corto: "ADA", sub: "La playa urbana", barrios: ["ada"], centro: [44.7906, 20.4051], radio: 2.1, path: "M25 305 Q140 275 290 315 L315 395 Q155 430 45 390 Z", label: [165, 350], visual: "sava-promenada", extras: {
      ...
      { id: "savski-venac", nombre: "Savski Venac · Savamala", corto: "SAVSKI VENAC", sub: "Vuestra base", barrios: ["savski-venac"], centro: [44.8050, 20.4560], radio: 1.45, path: "M370 220 Q455 185 535 225 L520 315 Q425 330 350 285 Z", label: [445, 255], visual: "belgrado-savamala", visualExt: "webp" },
      { id: "vracar", nombre: "Vračar · Slavija", corto: "VRAČAR", sub: "San Sava, mercado y cafés", barrios: ["vracar"], centro: [44.8000, 20.4720], radio: 1.55, path: "M540 220 Q635 195 705 245 L685 350 Q600 360 525 315 Z", label: [620, 270], visual: "san-sava", extras: {
      ...
      { id: "dedinje", nombre: "Dedinje · Topčider", corto: "DEDINJE", sub: "Tito, palacios y memoria", barrios: ["dedinje"], centro: [44.7830, 20.4520], radio: 2.0, path: "M335 325 Q455 300 585 345 L560 420 L350 420 Z", label: [455, 365], visual: "museo-yugoslavia", extras: {
  ...
  alrededores: [
    {
      ...
      como: "Tren rápido Soko desde Beograd Centar (Prokop): ~36 min, ≈603 RSD por trayecto en 2ª clase, con wifi y aire. Confirmado a 21-jul: el Soko circula cada 2 h aprox. de 6:00 a 22:00 (9 salidas por sentido), más algunos InterRegio; comprad ida y vuelta con asiento reservado en la app/web de Srbija Voz (5% dto.) la víspera. La parada se llama Novi Sad; Petrovaradin es la siguiente (útil si vais directos a la fortaleza).",
      ...
      fiab: "ok", fuente: "seat61 + Srbija Voz + stillinbelgrade · ver. 21-jul-2026"
    },
    {
    ...
    },
    {
      ...
      como: "Tren Soko desde Beograd Centar por la línea nueva de alta velocidad: 79 min por trayecto (¡a 200 km/h!), ≈9 € en 2ª clase. Confirmado a 21-jul: 9 salidas por sentido, una cada 2 h de 6:00 a 22:00, parando en Novi Beograd, Petrovaradin, Vrbas y Bačka Topola. Comprad ida y vuelta con asiento en la app de Srbija Voz la víspera.",
  ...
  costumbres: [
    ...
    { icono: "✊", titulo: "Sobre las protestas (leed esto)", texto: "Contexto: el movimiento nació con la tragedia de Novi Sad (nov. 2024, 16 muertos) y tras 18 meses de pulso ha llegado a su momento decisivo JUSTO ahora: el 27 de junio Vučić anunció que dimitirá «en cuestión de semanas» y que habrá elecciones anticipadas. Desde entonces la tensión ha subido, no bajado: gran protesta el 28-jun en Slavija con choques y decenas de detenidos, y una oleada de 400+ detenciones a principios de julio criticada por la ONU y el Consejo de Europa. Los manifestantes desconfían del anuncio (Vučić no ha puesto fecha ni a su marcha ni a las elecciones, y se espera que vuelva como primer ministro), así que SIGUEN en la calle — el pulso no se ha desinflado. Vais a estar en Belgrado en semanas potencialmente históricas, con concentraciones casi seguras, y OJO: Slavija, epicentro habitual, está a 10 minutos de vuestro apartamento. Qué significa para vosotros: presencia policial visible, cortes de tráfico, y quizá alguna noche de ruido de cacerolas o bocinas. Nada dirigido a turistas. Regla triple: (1) ante concentración o antidisturbios, cambiad de calle y seguid con vuestro plan; (2) cero fotos de cerca a cordones policiales; (3) mirad N1info.rs (en inglés) por la mañana — las convocatorias grandes se anuncian con días. Verificado la mañana del 22-jul (día de vuestra llegada): sin novedad brusca respecto a días atrás — Vučić sigue sin fijar fecha de dimisión ni de elecciones, los estudiantes siguen, y no hay anunciada ninguna gran concentración para hoy. Estáis llegando a una Belgrado en pulso, no en caos. Mirad N1info.rs (en inglés) cada mañana." },
  ],
  idioma: {
  ...
  /* ---------- PRÁCTICO ---------- */
  practico: {
    clima: { titulo: "Clima: os toca el mejor Belgrado posible", texto: "Confirmado la mañana del 22: la ola de calor extrema que ha achicharrado los Balcanes ha pasado de largo y os dejáis nueve días de tiempo ideal para caminar. Máximas de la semana entre 25 y 32 °C (los más cálidos, el domingo 26 y el jueves 30, rozando 30-32°; el resto, 25-29°), mínimas de 16-21° para terrazas de noche perfectas. La única pega es HOY, miércoles 22: llegáis con ~28° pero con probabilidad de chubascos (≈60%), y hay días sueltos de llovizna entre semana (24, 26-27) — un chubasquero fino o paraguas plegable en la mochila y listo. Nada del horno de julio de otros años. Anochece ~20:30.", fiab: "ok", fuente: "Open-Meteo + hidmet.gov.rs · ver. 22-jul-2026 (día de llegada)" },
    ...
    conectividad: { titulo: "Móvil y datos", texto: "Serbia está FUERA del roaming UE: los datos de vuestra tarifa española no valen (o cobran un dineral). CONFIRMADO: en el propio aeropuerto, en llegadas tras recoger maletas, hay kioscos de Yettel y de MTS (A1 no vende allí). Precios orientativos: Yettel ~700 RSD (≈6 €) con 15 GB / 15 días; MTS ~1.800 RSD con 10 GB + minutos / 30 días. Llevad el PASAPORTE en la mano: la ley serbia obliga a registrar la SIM. Ojo al horario: los kioscos cierran ~20:00 entre semana y antes el finde — aterrizáis el miércoles por la tarde, así que da tiempo pero JUSTO si el vuelo se retrasa. Plan B sin estrés: eSIM de viaje (Airalo/Holafly) activada desde casa, o kiosco de operador en la ciudad al día siguiente (hay por todas partes). El apartamento tendrá wifi.", fiab: "ok", fuente: "gigago + phonetravelwiz + foros · ver. 17-jul-2026" },
