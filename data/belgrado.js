...
const DATA = {
  ...
  dias: [
    { fecha: "2026-07-22", nota: "Llegada. Vuelo desde Madrid ~16:00 → Belgrado. OJO: la previsión da lluvia/chubascos esta tarde-noche (≈70%) — chubasquero a mano y primera noche de plan bajo techo: una kafana cercana, sin agobios. Recoged la SIM en el aeropuerto si el kiosco sigue abierto (cierra ~20:00).", tipo: "llegada" },
  ...
  /* ---------- PRÁCTICO ---------- */
  practico: {
    clima: { titulo: "Clima: buenas noticias (previsión real)", texto: "Sorpresa agradable: la ola de calor extrema que ha achicharrado los Balcanes estos días (cerca de 40 °C) AMAINA justo para vuestras fechas. Previsión a 21-jul para el 22-30: máximas suaves de 24 a 31 °C (el día más caluroso, el domingo 26, con ~31°), mínimas de 16-19° (noches frescas para las terrazas). El día de llegada, miércoles 22, viene con probabilidad alta de lluvia/chubascos (≈70%) y algún día suelto de llovizna entre semana — meted un chubasquero fino o paraguas plegable en la mochila. En conjunto, un tiempo IDEAL para caminar la ciudad: nada del horno de julio habitual. Anochece ~20:30.", fiab: "ok", fuente: "Open-Meteo + hidmet.gov.rs · ver. 21-jul-2026" },
